...
class VodClient {
  ...
  RedirectPlay = async () => {
    return this._base.request('RedirectPlay', {} as RequestOptions);
  };

  GetOriginVideoPlayInfo = async (): Promise<GetOriginVideoPlayInfoResp> => {
    return this._base.request('GetOriginVideoPlayInfo', {} as RequestOptions);
  };
  ...
  UploadMediaByUrl = async (): Promise<UploadMediaByUrlResp> => {
    return this._base.request('UploadMediaByUrl', {} as RequestOptions);
  };

  ApplyUpload = async (): Promise<ApplyUploadResp> => {
    return this._base.request('ApplyUpload', {} as RequestOptions);
  };
  ...
  ModifyVideoInfo = async (): Promise<ModifyVideoInfoResp> => {
    return this._base.request('ModifyVideoInfo', {} as RequestOptions);
  };
  ...
  SetVideoPublishStatus = async (SpaceName, Vid, Status: string): Promise<SetVideoPublishStatusResp> => {
    return this._base.request('SetVideoPublishStatus', {} as RequestOptions);
  };
