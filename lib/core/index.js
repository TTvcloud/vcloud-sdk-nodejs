...
const dispatch_request_1 = require("./dispatch-request");
...
class Client {
    ...
    async request(action, options = {}) {
        ...
        const chain = [
            ...
            dispatch_request_1.dispatchRequest(fetchOptions),
            format_response_1.formatResponse(this._configs),
            ...this._manager.postHandlers
        ];
        // return util.excuteWaterful(chain);
        return new query_1.default(chain).exec();
    }
}
